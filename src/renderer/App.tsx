  ...
  return (
    <div className="h-screen bg-slate-950 text-slate-100 flex flex-col font-sans antialiased overflow-hidden">
      ...
      <motion.header 
        ...
        className="bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/50 px-8 py-5 relative"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/5 to-purple-500/5"></div>
        <div className="relative flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-xl blur-lg opacity-30"></div>
              <div className="relative flex items-center justify-center w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-2xl">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 px-3 py-2 bg-slate-800/50 rounded-lg border border-slate-700/50">
              <div className={`w-2 h-2 rounded-full ${servers.some(s => s.connected) ? 'bg-emerald-400' : 'bg-slate-500'}`}></div>
            ...
            <button 
              ...
              className="group relative bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white px-6 py-2.5 rounded-xl flex items-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-indigo-500/25 hover:scale-105"
            >
            ...
            <button
              ...
              className="p-2.5 bg-slate-800/50 hover:bg-slate-700/50 text-slate-400 hover:text-slate-200 rounded-xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-200"
              title="Settings (Cmd+,)"
            >
          ...
          <nav className="p-6">
            <div className="space-y-3">
              {[
                ...
                const colorClasses = {
                  emerald: isActive ? "bg-emerald-500/20 border-emerald-500/30 text-emerald-300" : "hover:bg-emerald-500/10 hover:border-emerald-500/20",
                  blue: isActive ? "bg-blue-500/20 border-blue-500/30 text-blue-300" : "hover:bg-blue-500/10 hover:border-blue-500/20",
                  purple: isActive ? "bg-purple-500/20 border-purple-500/30 text-purple-300" : "hover:bg-purple-500/10 hover:border-purple-500/20",
                  amber: isActive ? "bg-amber-500/20 border-amber-500/30 text-amber-300" : "hover:bg-amber-500/10 hover:border-amber-500/20",
                  slate: isActive ? "bg-slate-500/20 border-slate-500/30 text-slate-300" : "hover:bg-slate-500/10 hover:border-slate-500/20",
                };
                ...
                return (
                  <button
                    ...
                    className={`group w-full flex items-center justify-between px-4 py-3 rounded-xl text-left transition-all duration-200 border ${
                      isActive
                        ? `${colorClasses[tab.color as keyof typeof colorClasses]} shadow-lg scale-105`
                        : `text-slate-300 border-transparent ${colorClasses[tab.color as keyof typeof colorClasses]} hover:text-white`
                    }`}
                  >
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-emerald-400">{servers.filter((s) => s.connected).length} online</span>
                </div>
                <div className="w-full bg-slate-700/50 rounded-full h-1.5">
                  <div
                    ...
                    style={{
                      width: `${
                        servers.length > 0
                          ? (servers.filter((s) => s.connected).length / servers.length) * 100
                          : 0
                      }%`,
                    }}
                  />
              ...
              {isLoading ? (
                ...
                <div className="grid gap-4">
                  {servers.map((server) => (
                    <div
                      key={server.id}
                      className="bg-zinc-800 rounded-xl border border-zinc-700 p-6 hover:border-zinc-600 transition-all duration-200"
                    >
