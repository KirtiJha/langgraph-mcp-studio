  ...
  const filteredNodeTypes = useMemo(() => {
    return nodeTypes.filter((nodeType) => {
      ...
      const matchesSearch =
        ...
        (nodeType.tags &&
          nodeType.tags.some((tag) => tag.includes(searchLower)));
  ...
  return (
    <div className="h-full flex flex-col bg-slate-900/50 border-r border-slate-800">
      ...
      <div className="flex-shrink-0 p-4 border-b border-slate-800">
        ...
        <div className="flex flex-wrap gap-1">
          ...
          {categories.map((category) => {
            ...
            const nodeCount = filteredNodeTypes.filter(
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        <Icon
                          className={`w-5 h-5 ${nodeType.color} transition-transform group-hover:scale-110`}
                        />
                      </div>
        ...
        {servers.length > 0 &&
          (selectedCategory === "all" || selectedCategory === "servers") && (
            <div>
