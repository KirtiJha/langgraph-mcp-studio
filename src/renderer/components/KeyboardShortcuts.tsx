...
const shortcuts: KeyboardShortcut[] = [
  { key: 'Cmd+1', description: 'Switch to Servers', action: 'switch-servers', category: 'Navigation' },
  { key: 'Cmd+2', description: 'Switch to Tools', action: 'switch-tools', category: 'Navigation' },
  { key: 'Cmd+3', description: 'Switch to Chat', action: 'switch-chat', category: 'Navigation' },
  { key: 'Cmd+4', description: 'Switch to Resources', action: 'switch-resources', category: 'Navigation' },
  { key: 'Cmd+5', description: 'Switch to Logs', action: 'switch-logs', category: 'Navigation' },
  { key: 'Cmd+N', description: 'Add New Server', action: 'add-server', category: 'Actions' },
  { key: 'Cmd+R', description: 'Refresh All', action: 'refresh', category: 'Actions' },
  { key: 'Cmd+,', description: 'Open Settings', action: 'open-settings', category: 'Actions' },
  { key: 'Cmd+K', description: 'Show Shortcuts', action: 'show-shortcuts', category: 'Help' },
  { key: 'Cmd+/', description: 'Show Help', action: 'show-help', category: 'Help' },
  { key: 'Escape', description: 'Close Modal/Panel', action: 'close-modal', category: 'General' },
  { key: 'Enter', description: 'Confirm Action', action: 'confirm', category: 'General' },
];
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Navigate MCP Studio faster with shortcuts</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsVisible(false)}
